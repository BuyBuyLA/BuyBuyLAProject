		...
		$('#updateDataId').click(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					$('#updImgshow').attr('src','/BuyBuyLa_beta_3/getPicture32/'+dataid);
					$('#updid').val(data['id']);
				}
			})
		});
					...
					<img src="" style="width: 50px; height: 50px; border-radius: 50%;"> 
						<span>${content.userName}</span>
                            ...
                            <ul class="dropdown-menu">
                              <li data-id="${content.id}" id="updateDataId" data-bs-toggle="modal" data-bs-target="#UpdateModal" class="dropdown-item">編輯</li>
